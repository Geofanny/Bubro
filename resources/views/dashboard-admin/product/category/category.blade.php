        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="/product-admin" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Product</a>
                    <a href="/category-admin" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Category</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
