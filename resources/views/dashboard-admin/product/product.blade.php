        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="/product-admin" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">
                            <i class="fa fa-warehouse me-2"></i>Inventory
                        </a>
                        <div class="dropdown-menu bg-light border-0 m-0">
                            <a href="/product-admin" class="dropdown-item">
                                <i class="fa fa-box me-2"></i>Product
                            </a>
                            <a href="/category-admin" class="dropdown-item">
